  ...
  try {
    ...
    if (!adminUsername || !adminPassword) {
      ...
      if (existingAdmin.length === 0) {
        ...
        console.log('⚠️  IMPORTANT: Keep .env file secure and never commit to git!');
      } else {
    ...
    if (error.code === 'ER_ACCESS_DENIED_ERROR') {
      ...
      console.error('🗄️  Database does not exist. Check DB_NAME in .env (should be "defaultdb" for Aiven)');
